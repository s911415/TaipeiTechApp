...
public class ClassroomListDialog extends DialogFragment implements
    ...
    public ClassroomListDialog() {

    }

    public static ClassroomListDialog newInstance(List items) {
        ClassroomListDialog multiSelectExpandableFragment = new
                ClassroomListDialog();
